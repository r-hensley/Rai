...
class Logger(commands.Cog):
    ...
    async def on_member_update(self: commands.Cog, before: discord.Member, after: discord.Member):
        ...
        async def phys_server_verification_check():
            ...
            important_role_ids = [968631535265796147,  # 2017
                                  968631629474037800,  # 2018
                                  968631666371346462,  # 2019
                                  968631689477763123,  # 2020
                                  968631711778869319,  # 2021
                                  968631736567214101,  # 2022
                                  1121216657772253204,  # 2023
                                  1244760241506357329,  # 2024
                                  1343827132199075954,  # 2025
                                  1501410919845204038,  # 2026
                                  1123015201642512558,  # Alumni
                                  1123015668590198834,  # Postdoc
                                  1123015305669640322]  # Not Graduate Student
            important_roles = []
